...
Version  : 1.5.8.2
Release  : 5
URL      : https://files.pythonhosted.org/packages/8c/d1/e2a15d7d4fcf9406d56451042395e3e20f1ab346c7158b22a0dc72766643/types-typed-ast-1.5.8.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/8c/d1/e2a15d7d4fcf9406d56451042395e3e20f1ab346c7158b22a0dc72766643/types-typed-ast-1.5.8.2.tar.gz
...
%prep
%setup -q -n types-typed-ast-1.5.8.2
cd %{_builddir}/types-typed-ast-1.5.8.2
pushd ..
cp -a types-typed-ast-1.5.8.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667924090
