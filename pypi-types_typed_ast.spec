...
Version  : 1.5.8.4
Release  : 8
URL      : https://files.pythonhosted.org/packages/58/6d/55a37fe9fc7944487b9e4e163d866af29d8eae6faea6073b953d31280bac/types-typed-ast-1.5.8.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/58/6d/55a37fe9fc7944487b9e4e163d866af29d8eae6faea6073b953d31280bac/types-typed-ast-1.5.8.4.tar.gz
...
%prep
%setup -q -n types-typed-ast-1.5.8.4
cd %{_builddir}/types-typed-ast-1.5.8.4
pushd ..
cp -a types-typed-ast-1.5.8.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676998942
