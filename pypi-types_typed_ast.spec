...
Version  : 1.5.8.1
Release  : 4
URL      : https://files.pythonhosted.org/packages/40/8f/fb453a353f2a805d52b34e2ff0effcb26d7a6406e4be7ef07136b2210060/types-typed-ast-1.5.8.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/40/8f/fb453a353f2a805d52b34e2ff0effcb26d7a6406e4be7ef07136b2210060/types-typed-ast-1.5.8.1.tar.gz
...
%prep
%setup -q -n types-typed-ast-1.5.8.1
cd %{_builddir}/types-typed-ast-1.5.8.1
pushd ..
cp -a types-typed-ast-1.5.8.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667228419
